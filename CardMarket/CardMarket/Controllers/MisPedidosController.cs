...
namespace CardMarket.Controllers
{
    public class MisPedidosController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            // Se selecciona el empleado correspondiente al usuario 
            ...
            //.Include(a => a.Cliente).Include(a => a.Equipo).Include(a => a.TipoAveria);
        ...
        public async Task<IActionResult> ConfirmarPedido(int? id)
        {
            ...
            return RedirectToAction(nameof(Index), "MisPedidos");
        }
